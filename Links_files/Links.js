...
{var registry=IWCreateEffectRegistry();registry.registerEffects({stroke_5:new IWEmptyStroke(),stroke_6:new IWEmptyStroke(),stroke_4:new IWEmptyStroke(),stroke_3:new IWEmptyStroke(),stroke_7:new IWEmptyStroke(),stroke_1:new IWEmptyStroke(),stroke_2:new IWEmptyStroke(),stroke_0:new IWEmptyStroke()});registry.applyEffects();}
function hostedOnDM()
{return false;}
function onPageLoad()
